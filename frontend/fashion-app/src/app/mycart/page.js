...
const MyCart = () => {
    ...
    return (
        <>
            ...
            <section class="m-4 bg-white py-8 antialiased dark:bg-gray-900 md:py-16 rounded-md">
                        ...
                        <div class="mx-auto w-full flex-none lg:max-w-2xl xl:max-w-4xl">
                            <div class="space-y-6">
                                <div class="rounded-lg border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-800 md:p-6">
                                    {Array.isArray(cartItems) && cartItems.length > 0 && cartItems.map((item, index) => (<div class="m-2 space-y-4 md:flex md:items-center md:justify-between md:gap-6 md:space-y-0">
                                        <a href="#" class="shrink-0 md:order-1">
                                            <img class="h-20 w-20 dark:hidden" src={item?.img} alt="imac image" />
                                            <img class="hidden h-40 w-30 dark:block" src={item?.img} alt="imac image" />
                                        </a>
                                        ...
                                        <div class="flex items-center justify-between md:order-3 md:justify-end">
                                            ...
                                            <div class="text-end md:order-4 md:w-32">
                                                <p class="text-base font-bold text-gray-900 dark:text-white">Rs. {item?.price}</p>
                                            </div>
                                        </div>
                                ...
                                <div class="space-y-4">
                                    <div class="space-y-2">
                                        <dl class="flex items-center justify-between gap-4">
                                            ...
                                            <dd class="text-base font-medium text-gray-900 dark:text-white">Rs. {totalPrice}</dd>
                                        </dl>

                                        <dl class="flex items-center justify-between gap-4">
                                            <dt class="text-base font-normal text-gray-500 dark:text-gray-400">Savings</dt>
                                            <dd class="text-base font-medium text-green-600">Rs. 0</dd>
                                        </dl>

                                        <dl class="flex items-center justify-between gap-4">
                                            <dt class="text-base font-normal text-gray-500 dark:text-gray-400">Store Pickup</dt>
                                            <dd class="text-base font-medium text-gray-900 dark:text-white">Rs. 0</dd>
                                        </dl>
                                    ...
                                    <dl class="flex items-center justify-between gap-4 border-t border-gray-200 pt-2 dark:border-gray-700">
                                        ...
                                        <dd class="text-base font-bold text-gray-900 dark:text-white">Rs. {totalPrice + 99}</dd>
                                    </dl>
                                </div>
